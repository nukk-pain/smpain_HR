...
### Week 1: Backend 개발
- [ ] Day 1-2: 데이터 스키마 설계 및 마이그레이션 스크립트
- [ ] Day 3-4: IncentiveService 클래스 구현
- [ ] Day 5: API 엔드포인트 개발 및 테스트

### Week 2: Frontend 개발
- [ ] Day 1-2: 인센티브 설정 UI 컴포넌트
- [ ] Day 3-4: 시뮬레이션 및 미리보기 기능
- [ ] Day 5: 통합 테스트

### Week 3: 테스트 및 배포
- [ ] Day 1-2: 단위 테스트 및 통합 테스트
- [ ] Day 3: 데이터 마이그레이션 실행
- [ ] Day 4-5: 배포 및 모니터링
