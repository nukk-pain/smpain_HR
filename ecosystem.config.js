  ...
  apps: [
    {
      ...
      env: {
        NODE_ENV: 'production',
        PORT: 5455,
        MONGODB_URL: 'mongodb://hr_app_user:Hr2025Secure@localhost:27018,localhost:27019,localhost:27020/SM_nomu?replicaSet=hrapp&authSource=SM_nomu&directConnection=false',
